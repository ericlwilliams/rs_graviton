...
#ifndef triangleCuts_h
#define triangleCuts_h
...
class triangleCuts : public TSelector {
public :
   ...
   triangleCuts(TTree * /*tree*/ =0) { }
   virtual ~triangleCuts() { }
   ...
   ClassDef(triangleCuts,0);
};

#endif

#ifdef triangleCuts_cxx
void triangleCuts::Init(TTree *tree)
{
