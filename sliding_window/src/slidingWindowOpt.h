...
// Thu Mar 29 13:43:24 2012 by ROOT version 5.28/00b
// from TTree analysisTree/analysisTree
// found on file: mc.alpgen.wenu.np2.pu.skim.root
//////////////////////////////////////////////////////////

#ifndef slidingWindowOpt_h
#define slidingWindowOpt_h
...
class slidingWindowOpt : public TSelector {
public :
   ...
   Float_t         lvjj_lep_track_iso;
   Float_t         lvjj_lep_d0sig;
   Float_t         lvjj_lep_absz0;
   Float_t         lead_jet_m;
   Float_t         lead_jet_pt;
   ...
   TBranch        *b_lvjj_lep_track_iso;   //!
   TBranch        *b_lvjj_lep_d0sig;   //!
   TBranch        *b_lvjj_lep_absz0;   //!
   ...
   slidingWindowOpt(TTree * /*tree*/ =0) { }
   virtual ~slidingWindowOpt() { }
   ...
   ClassDef(slidingWindowOpt,0);
};

#endif

#ifdef slidingWindowOpt_cxx
void slidingWindowOpt::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("lep_iso_sf", &lep_iso_sf, &b_lep_iso_sf);
   ...
   fChain->SetBranchAddress("lvjj_lep_track_iso", &lvjj_lep_track_iso, &b_lvjj_lep_track_iso);
   fChain->SetBranchAddress("lvjj_lep_d0sig", &lvjj_lep_d0sig, &b_lvjj_lep_d0sig);
   fChain->SetBranchAddress("lvjj_lep_absz0", &lvjj_lep_absz0, &b_lvjj_lep_absz0);
...
Bool_t slidingWindowOpt::Notify()
{
...
#endif // #ifdef slidingWindowOpt_cxx
