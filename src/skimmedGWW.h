...
class skimmedGWW : public TSelector {
public :
   ...
   TBranch        *b_lvjj_lep_smear_d0sig;	//!
   TBranch        *b_lvjj_lep_d0;	//!
   ...
   virtual bool    passSignal(double sig_m);
   ClassDef(skimmedGWW,0);
};

#endif

#ifdef skimmedGWW_cxx
void skimmedGWW::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("lvjj_lep_smear_d0sig", &lvjj_lep_smear_d0sig, &b_lvjj_lep_smear_d0sig);
   fChain->SetBranchAddress("lvjj_lep_d0", &lvjj_lep_d0, &b_lvjj_lep_d0);
