//////////////////////////////////////////////////////////
// metResolution script makes/fits MEx/y plots
// to be read for resolution plot
//////////////////////////////////////////////////////////

#ifndef metResolution_h
#define metResolution_h
...
class metResolution : public TSelector {
public :
   ...
   Float_t         lnuj_lep_up_ecorr;
   Float_t         lnuj_lep_down_ecorr;
   Float_t         lnuj_lep_up_res;
   Float_t         lnuj_lep_down_res;
   Float_t         lead_jet_m;
   Float_t         lead_jet_pt;
   ...
   TBranch        *b_lnuj_lep_up_ecorr;   //!
   TBranch        *b_lnuj_lep_down_ecorr;   //!
   TBranch        *b_lnuj_lep_up_res;   //!
   TBranch        *b_lnuj_lep_down_res;   //!
   TBranch        *b_lead_jet_m;   //!
   TBranch        *b_lead_jet_pt;   //!
   TBranch        *b_lead_jet_jer_pt;   //!
   ...
   metResolution(TTree * /*tree*/ =0) { }
   virtual ~metResolution() { }
   ...
   ClassDef(metResolution,0);
};

#endif

#ifdef metResolution_cxx
void metResolution::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("lnuj_lep_up_ecorr", &lnuj_lep_up_ecorr, &b_lnuj_lep_up_ecorr);
   fChain->SetBranchAddress("lnuj_lep_down_ecorr", &lnuj_lep_down_ecorr, &b_lnuj_lep_down_ecorr);   
   fChain->SetBranchAddress("lnuj_lep_up_res", &lnuj_lep_up_res, &b_lnuj_lep_up_res);
   fChain->SetBranchAddress("lnuj_lep_down_res", &lnuj_lep_down_res, &b_lnuj_lep_down_res);   
