...
#ifndef makeTruthSignalPlots_h
#define makeTruthSignalPlots_h
...
class makeTruthSignalPlots : public TSelector {
public :
   ...
   makeTruthSignalPlots(TTree * /*tree*/ =0) { }
   virtual ~makeTruthSignalPlots() { }
   ...
   ClassDef(makeTruthSignalPlots,0);
};

#endif

#ifdef makeTruthSignalPlots_cxx
void makeTruthSignalPlots::Init(TTree *tree)
{
...
Bool_t makeTruthSignalPlots::Notify()
{
...
#endif // #ifdef makeTruthSignalPlots_cxx
