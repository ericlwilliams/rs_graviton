void runTruthSignalPlotsConstituents(){
  ...
  cout<<"-"<<endl;
  kkg_m1000_chain->Process("../src/makeTruthSignalPlotsConstituents.C+",kkg_m1000_out_name.c_str());
  ...
  cout<<"-"<<endl;
  kkg_m500_chain->Process("../src/makeTruthSignalPlotsConstituents.C+",kkg_m500_out_name.c_str());
  ...
  cout<<"-"<<endl;
  rsg_m500_chain->Process("../src/makeTruthSignalPlotsConstituents.C+",rsg_m500_out_name.c_str());
  ...
  cout<<"-"<<endl;
  rsg_m1000_chain->Process("../src/makeTruthSignalPlotsConstituents.C+",rsg_m1000_out_name.c_str());
  ...
  cout<<"-"<<endl;
  wprime_m500_chain->Process("../src/makeTruthSignalPlotsConstituents.C+",wprime_m500_out_name.c_str());
  ...
  cout<<"-"<<endl;
  wprime_m1000_chain->Process("../src/makeTruthSignalPlotsConstituents.C+",wprime_m1000_out_name.c_str());
