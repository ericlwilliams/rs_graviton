//////////////////////////////////////////////////
// Script to make root files to be read by runLimit (or sent to thomas)
...
const float rebin_n=4;//4 -> 80GeV bins
//const float rebin_n=8;//8 -> 160GeV bins
//const float rebin_n=16;//16 -> 320GeV bins
...
void makeLimitWithSystematics(bool doData=true){
  ...
  for(int pr=0;pr<nProcs;pr++){ // el, mu
	...
	//if(sys_name=="vjets") continue; //done in makeVjetsSystatics.C
	...
	for(int m=0;m<nModulations;m++){//e.g. "up", "down"
	  ...
	  for(int lv=0;lv<nLimitVars;lv++){//e.g. lep_met_dijet_mt
	    ...
	    string new_file_name = (isNominal) ? proc_name+"_"+cur_cut_name+"_"+var_name : proc_name+"_"+cur_cut_name+"_"+sys_name+mod_name+var_name;

	    string cur_hist_name;
	    if(sys_name==""){//nom
	      cur_hist_name= hist_name+"_nom_nom_"+cur_cut_name+"_"+var_name;
	    }else{
	      cur_hist_name= hist_name+"_"+sys_name+mod_name+cur_cut_name+"_"+var_name;
	    }
		...
		return;
	      ...
	      // NEW, increased n bins for template making, now 100,0,2000
	      // Rebin(4) -> 80 GeV bins (was 70)
	      
	      cur_plot_hist->Rebin(rebin_n);
		...
		return;
	      ...
	      else if(cur_bkgd=="mc.rsg.m500.kmpl0_1") {cur_plot_hist->SetName("rsg_m500_kMpl0_1");}
	      else if(cur_bkgd=="mc.rsg.m750.kmpl0_1") {cur_plot_hist->SetName("rsg_m750_kMpl0_1");}
	      else if(cur_bkgd=="mc.rsg.m1000.kmpl0_1") {cur_plot_hist->SetName("rsg_m1000_kMpl0_1");}
	      else if(cur_bkgd=="mc.rsg.m1250.kmpl0_1") {cur_plot_hist->SetName("rsg_m1250_kMpl0_1");}
	      else if(cur_bkgd=="mc.rsg.m1500.kmpl0_1") {cur_plot_hist->SetName("rsg_m1500_kMpl0_1");}	  
	      ...
	      else if(cur_bkgd=="mc.wprime.wz.m500") {cur_plot_hist->SetName("wprime_m500");}
	      else if(cur_bkgd=="mc.wprime.wz.m600") {cur_plot_hist->SetName("wprime_m600");}
	      else if(cur_bkgd=="mc.wprime.wz.m700") {cur_plot_hist->SetName("wprime_m700");}
	      else if(cur_bkgd=="mc.wprime.wz.m800") {cur_plot_hist->SetName("wprime_m800");}
	      else if(cur_bkgd=="mc.wprime.wz.m900") {cur_plot_hist->SetName("wprime_m900");}
	      else if(cur_bkgd=="mc.wprime.wz.m1000") {cur_plot_hist->SetName("wprime_m1000");}
	      else if(cur_bkgd=="mc.wprime.wz.m1100") {cur_plot_hist->SetName("wprime_m1100");}
	      else if(cur_bkgd=="mc.wprime.wz.m1200") {cur_plot_hist->SetName("wprime_m1200");}
	      else if(cur_bkgd=="mc.wprime.wz.m1300") {cur_plot_hist->SetName("wprime_m1300");}
	      else if(cur_bkgd=="mc.wprime.wz.m1400") {cur_plot_hist->SetName("wprime_m1400");}
	      else if(cur_bkgd=="mc.wprime.wz.m1500") {cur_plot_hist->SetName("wprime_m1500");}

	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m500") {cur_plot_hist->SetName("kkg_m500");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m600") {cur_plot_hist->SetName("kkg_m600");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m700") {cur_plot_hist->SetName("kkg_m700");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m800") {cur_plot_hist->SetName("kkg_m800");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m900") {cur_plot_hist->SetName("kkg_m900");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m1000") {cur_plot_hist->SetName("kkg_m1000");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m1100") {cur_plot_hist->SetName("kkg_m1100");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m1200") {cur_plot_hist->SetName("kkg_m1200");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m1300") {cur_plot_hist->SetName("kkg_m1300");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m1400") {cur_plot_hist->SetName("kkg_m1400");}
	      else if(cur_bkgd=="mc.afii.kkg.lvjj.m1500") {cur_plot_hist->SetName("kkg_m1500");}
	      ...
	      else if(cur_bkgd=="qcd.alpgen") {cur_plot_hist->SetName("qcd");}	  
		...
		exit(0);
	      ...
	      if((cur_bkgd.find("mc.rsg")==string::npos) &&
		 (cur_bkgd.find("mc.afii.kkg")==string::npos) &&
	    ...
	    string data_file = "data.lnuj.plot.root";
	    ...
	    if(doData) cur_data_hist->Rebin(rebin_n);
