...
wwVarInfo::wwVarInfo(string varName){
  ...
  if(var_name=="met_proj"){
  ...
  }else if(var_name=="lead_jet_eta_frths"){
  ...
  }else if(var_name=="lep_sig_diff_qoverp"){

    var_title="((q/p)_{me} - (q/p)_{id})(#sigma_{me}+#sigma_{id})";
    n_bins=30;
    x_min=0;
    x_max=2*TMath::Pi();
    x_label="((q/p)_{me} - (q/p)_{id})/(#sigma_{me}+#sigma_{id})";
    //log_y=false;
  ...
  }else if(var_name=="dijet_pt_dijet_m"){
  ...
  }else if(var_name=="dijet_pt_frths_dijet_m"){
  ...
  }else if(var_name=="dijet_m_lep_met_mt"){
    ...
    x_min=40;
    x_max=100;
    x_label="M_{T}(lep,MET)";
    log_y=true;

  }else if(var_name=="dijet_m_dijet_dr"){
  ...
  }else if(var_name=="dijet_m_zoom_dijet_dr"){
  ...
  }else if(var_name=="nocut_dijet_pt"){
    ...
    var_title="p_{T}{(lep+E_{T}^{miss})";

    n_bins=150;
    x_min=0;
    x_max=650;
    x_label="p_{T}(lep,E_{T}^{miss}) [GeV]";
    ...
    x_min=0;
    x_max=650;
    x_label="p_{T}(lep,E_{T}^{miss})";

  }else if(var_name=="nocut_lep_met_pt"){

    var_title="p_{T}(lep,E_{T}^{miss}) [GeV]";
  ...
  }else if(var_name=="lep_eta_frths"){
  ...
  }else if(var_name=="nrw_vxp_n"){

    var_title="Vertex Multiplicity";
    n_bins=18;
    x_min=0.5;
    x_max=18.5;
    x_label="Vertex N (no pile-up reweighting)";
    log_y=false;
    ...
    x_min=0.5;
    x_max=18.5;
    x_label="Avg Int per Xing (no pile-up reweighting)";
    log_y=false;
