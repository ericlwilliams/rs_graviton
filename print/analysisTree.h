...
// Fri Mar 30 14:24:12 2012 by ROOT version 5.28/00b
// from TTree analysisTree/analysisTree
// found on file: ../files/skims/mc.mcatnlo.t1.pu.skim.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../files/skims/mc.mcatnlo.t1.pu.skim.root");
      if (!f) {
         f = new TFile("../files/skims/mc.mcatnlo.t1.pu.skim.root");
      }
