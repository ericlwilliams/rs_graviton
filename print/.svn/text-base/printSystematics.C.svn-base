...
void printSystematics(){
  ...
  cout<<endl;
  cout<<"%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"<<endl;
  cout<<"In printSystematics.C"<<endl;
  ...
  // //jes
  // string vars[] = {"jes_nom_lowm_lep_met_dijet_mt","jes_up_lowm_lep_met_dijet_mt","jes_down_lowm_lep_met_dijet_mt",
  // 		   "jes_nom_highm_lep_met_dijet_mt","jes_up_highm_lep_met_dijet_mt","jes_down_highm_lep_met_dijet_mt"};
  // int nVars = sizeof(vars)/sizeof(vars[0]);

  //jer
  string vars[] = {"jes_nom_lowm_lep_met_dijet_mt","jer_lowm_lep_met_dijet_mt",
  		   "jes_nom_highm_lep_met_dijet_mt","jer_highm_lep_met_dijet_mt"};
  int nVars = sizeof(vars)/sizeof(vars[0]);
  ...
  for(int v=0;v<nVars;v++){   
	...
	cout<<"histogram_painter->Draw("<<cur_to_print<<","<<cur_ctrl<<",'.png','gww',false)"<<endl;
	histogram_painter->Draw(cur_to_print.c_str(),cur_ctrl.c_str(),".png","gww",false);
      }
    }
  }
